...
class ContainerManifestResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this ContainerManifestResponse.  # noqa: E501


        :return: The data of this ContainerManifestResponse.  # noqa: E501
        :rtype: ContainerManifestResponseData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ContainerManifestResponse.


        :param data: The data of this ContainerManifestResponse.  # noqa: E501
