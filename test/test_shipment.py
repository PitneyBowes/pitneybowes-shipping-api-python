...
import pbshipping
from pbshipping.models.shipment import Shipment  # noqa: E501
...
class TestShipment(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pbshipping.models.shipment.Shipment()  # noqa: E501
        if include_optional :
            return Shipment(
                additional_addresses = [
                    pbshipping.models.additional_address.AdditionalAddress(
                ...
                alt_return_address = pbshipping.models.address.Address(
                    address_lines = [
                        '0'
                        ], 
                    carrier_route = '0', 
                    ...
                    tax_id_type = 'EIN', ), 
                carrier_payments = [
                    pbshipping.models.carrier_payment.CarrierPayment(
                        account_number = '0', 
                        country_code = '0', 
                        party = 'BILL_RECEIVER', 
                        postal_code = '0', 
                ...
                customs = pbshipping.models.customs.Customs(
                ...
                documents = [
                    pbshipping.models.document.Document(
                        content_type = 'URL', 
                        contents = '0', 
                        doc_tab = [
                ...
                from_address = pbshipping.models.address.Address(
                    address_lines = [
                        '0'
                        ], 
                    carrier_route = '0', 
                    ...
                    tax_id = '0', 
                    tax_id_type = 'EIN', ), 
                hazmat_details = pbshipping.models.hazmat_details.HazmatDetails(
                    ...
                    signatory = pbshipping.models.signatory.Signatory(
                        ...
                        place = '0', 
                        title = '0', ), ), 
                parcel = pbshipping.models.parcel.Parcel(
                    dimension = pbshipping.models.parcel_dimension.ParcelDimension(
                        length = 1.337, 
                        height = 1.337, 
                        width = 1.337, 
                        unit_of_measurement = 'CM', 
                        irregular_parcel_girth = 1.337, ), 
                    weight = pbshipping.models.parcel_weight.ParcelWeight(), 
                    value_of_goods = 1.337, 
                    currency_code = '0', ), 
                parcel_tracking_number = '0', 
                rates = [
                    pbshipping.models.rate.Rate(
                ...
                sold_to_address = pbshipping.models.address.Address(
                    address_lines = [
                        '0'
                        ], 
                    carrier_route = '0', 
                    ...
                    tax_id = '0', 
                    tax_id_type = 'EIN', ), 
                to_address = pbshipping.models.address.Address(
                    address_lines = [
                        '0'
                        ], 
                    carrier_route = '0', 
