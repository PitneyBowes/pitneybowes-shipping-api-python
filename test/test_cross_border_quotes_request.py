...
import pbshipping
from pbshipping.models.cross_border_quotes_request import CrossBorderQuotesRequest  # noqa: E501
...
class TestCrossBorderQuotesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pbshipping.models.cross_border_quotes_request.CrossBorderQuotesRequest()  # noqa: E501
        if include_optional :
            return CrossBorderQuotesRequest(
                ...
                to_address = pbshipping.models.address.Address(
                    ...
                    tax_id_type = 'EIN', ), 
                basket_items = [
                    pbshipping.models.cross_border_quotes_request_basket_items.CrossBorderQuotesRequest_basketItems(
                        item_id = '0', 
                        categories = [
                ...
                rates = [
                    pbshipping.models.cross_border_quotes_request_rates.CrossBorderQuotesRequest_rates(
                        carrier = '0', 
                        service_id = '0', )
                    ], 
                shipment_options = [
