...
from pitneybowes_shippingapi.models.carrier_rule import CarrierRule  # noqa: E501
...
class TestCarrierRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pitneybowes_shippingapi.models.carrier_rule.CarrierRule()  # noqa: E501
        if include_optional :
            return CarrierRule(
                service_id = 'EM', 
                branded_name = '0', 
                parcel_type_rules = [
                    pitneybowes_shippingapi.models.parcel_type_rules.ParcelTypeRules(
                        parcel_type = 'FLAT', 
                        branded_name = '0', 
                        rate_type_id = '0', 
