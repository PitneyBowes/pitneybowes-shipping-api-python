...
from pitneybowes_shippingapi.models.cross_border_quotes_response import CrossBorderQuotesResponse  # noqa: E501
...
class TestCrossBorderQuotesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pitneybowes_shippingapi.models.cross_border_quotes_response.CrossBorderQuotesResponse()  # noqa: E501
        if include_optional :
            return CrossBorderQuotesResponse(
                quote = [
                    pitneybowes_shippingapi.models.cross_border_quotes_response_quote.CrossBorderQuotesResponse_quote(
                        quote_currency = '0', 
                        quote_lines = [
