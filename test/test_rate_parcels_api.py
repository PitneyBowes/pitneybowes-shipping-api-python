...
from pitneybowes_shippingapi.api.rate_parcels_api import RateParcelsApi  # noqa: E501
...
class TestRateParcelsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pitneybowes_shippingapi.api.rate_parcels_api.RateParcelsApi()  # noqa: E501
