...
import pbshipping
from pbshipping.models.parcel_protection_policy_response import ParcelProtectionPolicyResponse  # noqa: E501
...
class TestParcelProtectionPolicyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pbshipping.models.parcel_protection_policy_response.ParcelProtectionPolicyResponse()  # noqa: E501
        if include_optional :
            return ParcelProtectionPolicyResponse(
                content = [
                    pbshipping.models.parcel_protection_policy_response_content.ParcelProtectionPolicyResponse_content(
                        transaction_id = '0', 
                        developer_id = '0', 
                ...
                sort = [
                    pbshipping.models.parcel_protection_policy_response_sort.ParcelProtectionPolicyResponse_sort(
                        direction = '0', 
                        property = '0', 
                        ignore_case = True, 
                        null_handling = '0', 
