...
with pbshipping.ApiClient(configuration) as api_client:
    ...
    api_instance = pbshipping.CarrierInfoApi(api_client)
...
origin_country_code = pbshipping.ISOCountryCode() # ISOCountryCode | The two-character ISO country code for the country where the shipment originates.
x_pb_unified_error_structure = True # bool | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional) (default to True)
...
with pbshipping.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pbshipping.CarrierInfoApi(api_client)
    carrier = pbshipping.Carrier() # Carrier | The carrier name. **Currently this must be set to: USPS** 
origin_country_code = pbshipping.ISOCountryCode() # ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates.
destination_country_code = pbshipping.ISOCountryCode() # ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment's destination address.
x_pb_unified_error_structure = True # bool | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional) (default to True)
